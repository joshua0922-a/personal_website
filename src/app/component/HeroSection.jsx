        ...
        <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="col-span-7 place-self-center text-center sm:text-left">
                ...
                <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
                    I'm a IT with a passion for building web applications.
                    I love working with React, Node.js, and MongoDB.
                </p>
                <div>
                    <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-red-500 hover:bg-slate-200 text-white'>Hire Me</button>
            ...
            <div className="col-span-5 place-self-center mt-4 lg:mt-0">
                <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] relative overflow-hidden">
                    <Image
                        src="/images/code.jpg"
                        alt=" Image"
                        width={300}
